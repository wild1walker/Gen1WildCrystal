#!/usr/bin/env python3
"""Draw label.png: the Wild Crystal cartridge art, scaled to the launcher's size.
...
The artwork is `art/wild_crystal_label.png`, committed whole at the size it
was drawn.  Nothing is composited here and no lettering is drawn: the piece
already carries the Gen1Wild wordmark and WILD CRYSTAL VERSION under it, so
...
against the shell and separates on its own.
...
ART = ROOT / "art" / "wild_crystal_label.png"
OUT = ROOT / "label.png"
